          ...
          <div className="mt-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-600">
                ...
                <Link
                  href="/auth/register"
                  className="font-medium text-[#41E2BA] hover:text-[#35c5a1] relative after:absolute after:bg-[#41E2BA] after:bottom-0 after:left-0 after:h-[1px] after:w-0 hover:after:w-full after:transition-all after:duration-300"
                >
                  Sign up
                </Link>
              </p>
